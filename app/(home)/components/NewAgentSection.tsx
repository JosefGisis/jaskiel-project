	...
	return (
		<section id="services">
			<div className="xl-container flex flex-col items-center mb-16">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-auto-columns: minmax(0, 1fr) gap-5">
...
export const agents: AgentInfoType[] = [
	{
        ...
        `,
		imageURL: "images/Esther Gisis.zip - 1.png",
	...
	},
	{
		...
		imageURL: "images/Esther Gisis.zip - 2.png",
	...
	},
	{
		...
		imageURL: "images/Esther Gisis.zip - 3.png",
	...
	},
	{
        ...
        `,
		imageURL: "images/Esther Gisis.zip - 4.png",
